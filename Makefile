...
INCLUDE =   libft.h
SOURCES =   ft_atoi.c ft_bzero.c ft_calloc.c t_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c 
...
ft_strlcpy.c ft_strlen.c ft_strmapi.c ft_strncmp.c ft_strnstr.c ft_strrchr.c ft_substr.c ft_tolower.c t_toupper.c
t_strtrim.c
